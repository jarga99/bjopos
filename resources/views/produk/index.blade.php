    ...
    function editForm(url) {
        ...
        $.get(url)
            .done((response) => {
                ...
                $('#modal-form [name=harga_beli]').val(response.modal.harga_beli);
                $('#modal-form [name=harga_jual]').val(response.harga.harga_jual);
                $('#modal-form [name=stok]').val(response.stock.stok_produk);
            })
            .fail((errors) => {
