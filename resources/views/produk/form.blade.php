        ...
        <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    {{-- new --}}
                    {{-- <div class="form-group row">
                        <label for="id_discount" class="col-lg-2 col-lg-offset-1 control-label">Diskon</label>
                        <div class="col-lg-6">
                            <select name="id_discount" id="id_discount" class="form-control" required>
                                <option value="">Pilih Diskon</option>
                                @foreach ($discount as $dis)
                                    <option value="{{ $dis->id }}">{{ $dis->nama_discount }} - {{ $dis->amount }}</option>
                                @endforeach
                            </select>
                            <span class="help-block with-errors"></span>
                        </div>
