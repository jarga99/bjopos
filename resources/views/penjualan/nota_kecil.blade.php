...
<body onload="window.print()">
    ...
    <table width="100%" style="border: 0;">
        @foreach ($detail as $item)
            ...
            <tr>
                <td>{{ $item->jumlah }} x {{ format_uang($item->harga->harga_jual) }}</td>
                <td></td>
                <td class="text-right">{{ format_uang($item->jumlah * $item->harga->harga_jual) }}</td>
            </tr>
        @endforeach
    </table>
    <p class="text-center">-----------------------------------</p>
    ...
    <p class="text-center">-- ATAS PEMBELIANYA --</p>
